interface IUserRepository {
    ...
    getPasswordById(email: string): Promise<string>;
    ...
    getVerificationTokenExpiryDateById(id: string): Promise<string>;
    getVerificationTokenExpiryDateByEmail(email: string): Promise<string>;
    updateVerificationTokenExpiryDateById(id: string, verificationTokenExpiryDate: string): Promise<void>;
    updateVerificationTokenExpiryDateByEmail(email: string, verificationTokenExpiryDate: string): Promise<void>;
