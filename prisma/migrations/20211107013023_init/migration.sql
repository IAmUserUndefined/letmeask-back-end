...
CREATE TABLE `User` (
    ...
    `verificationTokenExpiryTime` BIGINT NOT NULL DEFAULT 0,
...
CREATE TABLE `Question` (
    ...
    UNIQUE INDEX `Question_roomId_key`(`roomId`),
...
CREATE TABLE `Response` (
    ...
    UNIQUE INDEX `Response_questionId_key`(`questionId`),
    UNIQUE INDEX `Response_code_key`(`code`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
